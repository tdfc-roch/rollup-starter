...
const typeMap: any = {
  RuntimeCall: o(
    [
      ...
      {
        json: "sequencer_registry",
        js: "sequencer_registry",
        typ: u(undefined, r("CallMessage3")),
      },
      {
        json: "operator_incentives",
        js: "operator_incentives",
        typ: u(undefined, r("CallMessage4")),
      },
      {
        json: "attester_incentives",
        js: "attester_incentives",
        typ: u(undefined, u(r("CallMessage5Class"), r("CallMessage5Enum"))),
      },
      {
        json: "prover_incentives",
        js: "prover_incentives",
        typ: u(undefined, u(r("CallMessage6Class"), r("CallMessage6Enum"))),
      },
      {
        json: "value_setter",
        js: "value_setter",
        typ: u(undefined, r("CallMessage7")),
      },
      ...
      { json: "blob_storage", js: "blob_storage", typ: u(undefined, null) },
      {
        json: "paymaster",
        js: "paymaster",
        typ: u(undefined, r("CallMessage8")),
      },
      { json: "mailbox", js: "mailbox", typ: u(undefined, r("CallMessage9")) },
      {
        json: "interchain_gas_paymaster",
        js: "interchain_gas_paymaster",
        typ: u(undefined, r("CallMessage10")),
      },
      {
        json: "merkle_tree_hook",
        js: "merkle_tree_hook",
      ...
      },
      {
        json: "warp",
        js: "warp",
        typ: u(undefined, r("CallMessageForConfigurableSpec")),
      },
    ],
    false
  ),
  ...
  CallMessage5Class: o(
    [
      {
        json: "register_attester",
        js: "register_attester",
        typ: u(undefined, 0),
      },
      {
        json: "register_challenger",
        js: "register_challenger",
        typ: u(undefined, 0),
      },
      {
        json: "deposit_attester",
        js: "deposit_attester",
        typ: u(undefined, 0),
      },
    ],
  ...
  Burn: o([{ json: "coins", js: "coins", typ: r("Coins") }], "any"),
  Coins: o(
    [
  ...
  Freeze: o([{ json: "token_id", js: "token_id", typ: "" }], "any"),
  Mint: o(
    [
  ...
  CallMessage7: o([{ json: "set_value", js: "set_value", typ: 0 }], false),
  CallMessage10: o(
    [
      {
        json: "set_relayer_config",
        js: "set_relayer_config",
        typ: u(undefined, r("SetRelayerConfig")),
      },
      {
        json: "update_oracle_data",
        js: "update_oracle_data",
        typ: u(undefined, r("UpdateOracleData")),
      },
      {
        json: "claim_rewards",
        js: "claim_rewards",
        typ: u(undefined, r("ClaimRewards")),
      },
    ],
    false
  ),
  ...
  SetRelayerConfig: o(
    [
      ...
      {
        json: "domain_default_gas",
        js: "domain_default_gas",
        typ: a(r("DomainDefaultGas")),
      },
      {
        json: "domain_oracle_data",
        js: "domain_oracle_data",
        typ: a(r("DomainOracleData")),
      },
    ],
    "any"
  ),
  ...
  CallMessage4: o(
    [
      {
        json: "update_reward_address",
        js: "update_reward_address",
        typ: r("UpdateRewardAddress"),
      },
    ],
    false
  ),
  ...
  CallMessage8: o(
    [
      {
        json: "register_paymaster",
        js: "register_paymaster",
        typ: u(undefined, r("RegisterPaymaster")),
      },
      {
        json: "set_payer_for_sequencer",
        js: "set_payer_for_sequencer",
        typ: u(undefined, r("SetPayerForSequencer")),
      },
      {
        json: "update_policy",
        js: "update_policy",
        typ: u(undefined, r("UpdatePolicy")),
      },
    ],
    false
  ),
  ...
  PaymasterPolicyInitializer: o(
    [
      {
        json: "authorized_sequencers",
        js: "authorized_sequencers",
        typ: u(r("AuthorizedSequencersClass"), r("AuthorizedSequencersEnum")),
      },
      { json: "authorized_updaters", js: "authorized_updaters", typ: a("") },
      {
        json: "default_payee_policy",
        js: "default_payee_policy",
        typ: u(r("PayeePolicyClass"), r("PayeePolicyEnum")),
      },
  ...
  PayeePolicyClass: o([{ json: "allow", js: "allow", typ: r("Allow") }], false),
  Allow: o(
    [
      {
        json: "gas_limit",
        js: "gas_limit",
        typ: u(undefined, u(a(3.14), null)),
      },
      ...
      {
        json: "transaction_limit",
        js: "transaction_limit",
        typ: u(undefined, u(0, null)),
      },
    ],
    "any"
  ),
  SetPayerForSequencer: o([{ json: "payer", js: "payer", typ: "" }], "any"),
  CallMessage6Class: o(
    [
  ...
  CallMessage3: o(
    [
      ...
      {
        json: "initiate_withdrawal",
        js: "initiate_withdrawal",
        typ: u(undefined, r("InitiateWithdrawal")),
      },
  ...
  Withdraw: o([{ json: "da_address", js: "da_address", typ: "" }], "any"),
  CallMessageForConfigurableSpec: o(
    [
      {
        json: "Register",
        js: "Register",
        typ: u(undefined, r("RegisterObject")),
      },
      { json: "Update", js: "Update", typ: u(undefined, r("Update")) },
      {
        json: "EnrollRemoteRouter",
        js: "EnrollRemoteRouter",
        typ: u(undefined, r("EnrollRemoteRouter")),
      },
      {
        json: "UnEnrollRemoteRouter",
        js: "UnEnrollRemoteRouter",
        typ: u(undefined, r("UnEnrollRemoteRouter")),
      },
      {
        json: "TransferRemote",
        js: "TransferRemote",
        typ: u(undefined, r("TransferRemote")),
      },
    ],
    false
  ),
    ...
    [
      {
        ...
        js: "admin",
        typ: u(
          r("AdminForConfigurableSpecClass"),
          r("AdminForConfigurableSpecEnum")
        ),
      },
      ...
      { json: "remote_routers", js: "remote_routers", typ: a(a(u(0, ""))) },
      {
        json: "token_source",
        js: "token_source",
        typ: u(r("TokenKindClass"), r("TokenKindEnum")),
      },
    ],
    "any"
  ),
    ...
    [
      {
        json: "TrustedRelayer",
        js: "TrustedRelayer",
        typ: u(undefined, r("TrustedRelayer")),
      },
      {
        json: "MessageIdMultisig",
        js: "MessageIdMultisig",
        typ: u(undefined, r("MessageIDMultisig")),
      },
    ],
    false
  ),
  ...
  TrustedRelayer: o([{ json: "relayer", js: "relayer", typ: "" }], "any"),
  TokenKindClass: o(
    [
      { json: "Synthetic", js: "Synthetic", typ: u(undefined, r("Synthetic")) },
      {
        json: "Collateral",
        js: "Collateral",
        typ: u(undefined, r("Collateral")),
      },
    ],
    false
  ),
  Collateral: o([{ json: "token", js: "token", typ: "" }], "any"),
  Synthetic: o(
    [
      {
        json: "local_decimals",
  ...
  Update: o(
    [
      ...
      },
      {
        json: "ism",
        js: "ism",
        typ: u(undefined, u(r("IsmIsmClass"), r("IsmEnum"), null)),
      },
      { json: "warp_route", js: "warp_route", typ: "" },
    ],
    "any"
  ...
  CallMessage5Enum: ["begin_exit_attester", "exit_attester", "exit_challenger"],
  AuthorizedSequencersEnum: ["all"],
  PayeePolicyEnum: ["deny"],
  CallMessage6Enum: ["exit"],
  AdminForConfigurableSpecEnum: ["None"],
  IsmEnum: ["AlwaysTrust"],
  TokenKindEnum: ["Native"],
};
